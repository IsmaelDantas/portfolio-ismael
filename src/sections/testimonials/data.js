...
const data = [
        ...
        avatar: Avatar1,
        name: 'Eliel Cavalcante',
        profession: 'Bank clerk'
        },
        {
        id: 2,
        quote: "Good job, Ismael! Right on time! I really like how the project turned out, and my customers like it as well. It was fun collaborating with you.",
        avatar: Avatar2,
        name: 'Lucielma Costa',
        ...
        {
        id: 5,
        quote: "I like how the app turned out. You are incredible, Ismael.",
        avatar: Avatar5,
        name: 'Enzo Aragão',
        profession: 'Lawyer'
        },
        ...
        {
        id: 7,
        quote: "Keep doing great stuff, man! Nicely executed!",
        avatar: Avatar7,
        name: 'William Silva',
